...
struct obs_core_video {
	...
	uint64_t                        video_time;
	uint32_t                        real_frame_rate; //实际渲染帧率
...
/* user hotkeys *///tan close obs hotkeys
//struct obs_core_hotkeys {
...
struct obs_core {
	...
	//struct obs_core_hotkeys         hotkeys;//tan close obs hotkeys
};
...
struct obs_source {
	...
	uint64_t                        next_audio_ts_min; //下一次数据最小要间隔的时间
	...
	/* sources specific hotkeys *///tan close obs hotkeys
