...
EXPORT void base_get_log_handler_1(log_handler_t *handler, void **param);
EXPORT void base_set_log_handler_1(log_handler_t handler, void *param);
...
//打印行号， 方法， 
#define BLOG(log_level,fmt,...)   blog(log_level,"%s(%d)-<%s>: "##fmt, __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
