...
struct obs_source_info {
	...
	* @return         The properties data
	*/
	properties_t *(*get_all_property)(void *data);
	...
	* @return		  The property
	*/
	property_t *(*get_property)(void *data, const char *name);
	...
	*/
	...
	//用于上层向底层传参
	void(*set_parameter)(void *data, void *param);
};
