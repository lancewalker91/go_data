...
//给property绑定属性
EXPORT void obs_property_set_param(obs_property_t *property, void *param, void(*destroy)(void *param));
EXPORT void *obs_property_get_param(obs_property_t *property);
...
//设置list的当前值
EXPORT void obs_property_list_set_current(obs_property_t *p, int idx);
EXPORT int obs_property_list_current(obs_property_t *p);
